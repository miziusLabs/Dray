...
import { buildTranscript, type QuestionsAskedPayload } from "@/lib/transcript";
...
type ChatProps = {
  ...
  /// Answers an `AskUserQuestion`. Blocks the agent, and an empty
...
///
/// Answering one question and being asked the next are two separate events, so they land
...
function useLingeringCards(pending: QuestionsAskedPayload[]): QuestionsAskedPayload[] {
