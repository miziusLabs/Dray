...
export default function Home() {
  return (
    <div className="max-w-2xl px-6 min-[1920px]:mx-auto">
      ...
      <main>
        ...
        {/* No window chrome around this: the capture is of a real desktop and
            ...
            cap is what keeps the page inside one screen: everything above it is
            ~330px, so the image yielding on short windows is what stops a
            scrollbar rather than a pile of tightened paddings. */}
        <Image
          src={screenshot}
          alt="Dray showing a session transcript beside a per-turn diff of the files that turn changed"
          priority
          sizes="(max-width: 672px) 100vw, 672px"
          className="mb-6 h-auto max-h-[50vh] w-auto rounded-xl border border-border"
        />
      </main>
    </div>
  );
